...
static int compute_number_length(int nb)
{
    int count = 0;
...
static void collect_word_sizes(int* wlen)
{
    int c;
    int current_len = 0;
...
static void draw_graph_bar(int* wlen, int bar_pad)
{
    bool gap = false;
...
static void draw_graph_labels(int* wlen, int bar_pad)
{
    // label separation
    bool gap = false;
    for (int i = 0; i < MAX_WORD_LENGTH; i++)
...
static void render_graph(int* wlen)
{
